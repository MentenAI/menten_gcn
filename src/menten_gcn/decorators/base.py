...
class Decorator:
    ...
    def calc_node_features(self, wrapped_pose: WrappedPose,
                           resid: int, dict_cache: dict = None) -> list:
        """
    ...
    def describe_node_features(self) -> list:
    ...
    def calc_edge_features(self, wrapped_pose: WrappedPose,
                           resid1: int, resid2: int, dict_cache: dict = None) -> list, list:
        """
        This does all of the business logic of calculating
    ...
    def describe_edge_features(self) -> list:
        # Describe in reproducible detail how these numbers are calculated
        return []
...
class CombinedDecorator(Decorator):
    ...
    def calc_node_features(self, wrapped_pose: WrappedPose, resid: int, dict_cache: dict = None):
        ...
        '''
        for d in self.decorators:
            print( d.get_version_name(), d.n_node_features(), len( d.calc_node_features( wrapped_pose, resid=resid, dict_cache=dict_cache ) ) )
